...
async function run() {
    try {
        await db_1.default.query('ALTER TABLE Products ADD COLUMN unit_cost DECIMAL(10,2) DEFAULT 0.00;');
        await db_1.default.query('ALTER TABLE Products ADD COLUMN location VARCHAR(100);');
    ...
    try {
        await db_1.default.query('ALTER TABLE Sale_Items ADD COLUMN product_id INT;');
        await db_1.default.query('ALTER TABLE Sale_Items ADD CONSTRAINT fk_product FOREIGN KEY (product_id) REFERENCES Products(product_id) ON DELETE RESTRICT;');
        await db_1.default.query("ALTER TABLE Sale_Items ADD COLUMN item_type VARCHAR(50) DEFAULT 'otc';");
        await db_1.default.query('ALTER TABLE Sale_Items ADD COLUMN frequency VARCHAR(50);');
    ...
    try {
        await db_1.default.query('ALTER TABLE Supplier_Invoice_Items ADD COLUMN pack_size INT NOT NULL DEFAULT 1;');
